...
def get_runner_resources(runner_label):
    ...
    if runner_label == "slurm-runner-small":
        ...
        return {"cpu" : 2, "mem-per-cpu" : "2G", "tmpdisk" : TMPDISK_DEFAULT, "time" : "00:30:00"}
    elif runner_label == "slurm-runner-large":
        return {"cpu" : 4, "mem-per-cpu" : "2G", "tmpdisk" : TMPDISK_DEFAULT, "time" : "00:30:00"}
    elif runner_label == "slurm-runner-xlarge":
        return {"cpu" : 16, "mem-per-cpu" : "2G", "tmpdisk" : TMPDISK_DEFAULT, "time" : "00:30:00"}
    elif runner_label == "slurm-runner-medium-long-running":
        return {"cpu" : 4, "mem-per-cpu" : "2G", "tmpdisk" : TMPDISK_DEFAULT, "time" : "06:00:00"}
        ...
        try:
            ...
            cpu = int(match.group("cpu")) or 2
            mem_per_cpu = int(match.group("mem_per_cpu")) or 2
            ...
            raise ValueError(f"Failed to parse runner label {runner_label}. Error: {e}")
        else:
